...
import com.chl.boot.restful.common.AjaxResponse;
import com.chl.boot.restful.model.Article;
import com.chl.boot.restful.model.Reader;
...
//    }
    ...
    public AjaxResponse saveArticleByParams(
            ...
            @RequestParam(value = "author", defaultValue = "chl", required = false) String author,
